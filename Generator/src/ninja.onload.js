...
if (ninja.getQueryString()["showseedpool"] == "true" || ninja.getQueryString()["showseedpool"] == "1") {
	document.getElementById("seedpoolarea").style.display = "block";
	  ...
	  document.getElementById("privkey").value = 'Waiting for entropy';
	  document.getElementById("bisaddress").value = 'Waiting for entropy';

	  document.getElementById("pubkey").value =  'Waiting for entropy';
